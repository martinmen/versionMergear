...
public class EventoTest extends SpringTest {
    ...
    public void CrearYConsultarEventos() {
        ...
        assertThat(listaEventos.size()).isEqualTo(8);
    ...
    public void listarEventosCreadoPor(){
        ...
        Evento evento1 = new Evento("BA Corre", "Running, Caminatas, Acondicionamiento Físico", "Recoleta, Plaza Houssay","https://www.quepasaweb.com.ar/wp-content/uploads/2018/07/caminata-3.png",mtvandoni,"Alta");

        Evento evento2 = new Evento("Núcleos BA", "Basket, educación física infantil y Vóley.", "Flores, Espacio Juan XXIII","http://sansalvadordejujuy.gob.ar/wp-content/uploads/2017/05/Deportes-1.jpg", dchamorro, "Baja");

        Evento evento3 = new Evento("Núcleos BA", "Gimnasia para adultos", "Mataderos, Polideportivo Dorrego", "http://isanidad.com/wp-content/uploads/2017/05/ejercicio_mayores.jpg", dchamorro, "Media");

        Evento evento4 = new Evento("BA Zona Oeste", "Gimnasia para Jovenes", "Mataderos, Polideportivo Dorrego", "http://isanidad.com/wp-content/uploads/2017/05/ejercicio_mayores.jpg", mendezOng, "Alta");
...
String dificultad = "Baja";
        ...
        assertThat(listarTodosLosEventosConDificultadAlta).hasSize(2);
}
}
