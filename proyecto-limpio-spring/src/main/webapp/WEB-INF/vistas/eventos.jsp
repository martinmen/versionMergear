                ...
                <div class="row page-title-header">
                    ...
                    <div class="col-6">
                        <div class="page-header">
                            ...
                            <input name="dificultad" id="evento" type="text" value=""/>
                                <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">Buscar</button>
                            </form>
                   <%--         <form:form action="filtro" method="POST" modelAttribute="evento" >
                                <div class="form-label-group validate-input" data-validate = "Enter username">
                                    <form:input path="dificultad" id="dificultad"  class="form-control input100" name="Evento" placeholder="dificultad"/>
